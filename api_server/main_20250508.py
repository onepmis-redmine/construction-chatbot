...
def ask_question(q: Question):
    ...
    # 다음은 시스템 매뉴얼의 일부입니다. 이 내용을 참고하여 사용자의 질문에 정확히 답변해 주세요. 매뉴얼에서 답을 찾았다면 바로 보여주세요.
    # 당신은 건설정보시스템 전문가입니다. 아래 제공된 매뉴얼 내용을 기반으로만 사용자의 질문에 짧고 명확하게 답변하세요. 답변할 수 없는 경우 "매뉴얼에 해당 정보가 없습니다. 관리자에게 문의하세요. 02-6438-2086,7"라고 응답하세요.
